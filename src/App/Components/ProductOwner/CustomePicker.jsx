...
const CustomePicker = React.memo(({ productOwners, onPick, setShowProductOwnerPicker }) => {
  ...
  return (
    <div className="productOwner-customePicker">
      <div className="closeIcon" onClick={() => {setShowProductOwnerPicker(false)}}><CloseIcon /></div>
      <p className="title">لیست صاحب بار ها<SupervisorAccountIcon /></p>
      <input
        onChange={(e) => {
